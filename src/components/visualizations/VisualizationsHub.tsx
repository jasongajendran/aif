...
export const VisualizationsHub: React.FC<VisualizationsHubProps> = ({
  ...
  const visualizers: {
  ...
  }[] = [
    {
      id: 'rag-architecture',
      number: 1,
      title: 'Retrieval-Augmented Generation (RAG) & Knowledge Bases Architecture',
      shortTitle: 'RAG & Knowledge Bases',
      subtitle: '2-Phase Pipeline: Ingestion & Runtime Inference',
      description: 'Interactive pipeline visualizing vector embeddings, chunking strategies, Amazon OpenSearch Serverless, and Top-K context retrieval.',
      domain: 'Domain 2 & 3',
      icon: Database,
    ...
    },
    {
      ...
      number: 2,
      title: 'Foundation Model (FM) Customization Spectrum',
      shortTitle: 'Model Customization',
      subtitle: 'Prompt Eng ➔ Retrieval-Augmented Generation (RAG) ➔ Fine-Tuning ➔ Pre-Training',
      description: 'Compare the 5 customization tiers on cost, data volume requirements, weight modifications, and compute overhead.',
      domain: 'Domain 2: Generative AI (GenAI)',
      icon: Sliders,
    ...
    },
    {
      ...
      number: 3,
      title: 'Amazon Bedrock & 5-Layer Guardrails Safety Architecture',
      shortTitle: 'Bedrock & Guardrails',
      subtitle: 'Unified API & Multi-Layer Safety Firewall',
      description: 'Explore the 5 guardrail safety layers (Denied Topics, Content Filters, Sensitive Information / Personally Identifiable Information [PII], Word Filters, Contextual Grounding) with live prompt testing.',
      domain: 'Domain 3 & 4',
      icon: ShieldCheck,
    ...
    },
    {
      ...
      number: 4,
      title: 'SageMaker Governance & Drift Monitor Architecture',
      shortTitle: 'SageMaker & Governance',
      subtitle: 'Pre-Training Bias, Cards, Shapley Additive exPlanations (SHAP) & 4 Drift Types',
      description: 'End-to-end Machine Learning Operations (MLOps) pipeline covering SageMaker Clarify pre-training bias, Model Cards fact sheets, SHAP explainability, and Model Monitor drift simulation.',
    ...
    },
    {
      ...
      number: 5,
      title: 'AWS AI Service Selection Decision Tree & Scenario Matcher',
      shortTitle: 'AWS Service Selector',
      subtitle: 'Scenario Matcher: Textract (OCR), Comprehend (NER/NLP), Polly (TTS), Transcribe (ASR)',
    ...
    },
    {
      id: 'confusion-matrix',
      number: 6,
      title: 'Machine Learning (ML) Evaluation Metrics & Confusion Matrix Simulator',
      shortTitle: 'Metrics & Confusion Matrix',
      subtitle: 'Interactive TP/FP/FN/TN Matrix + ROUGE, BLEU, BERTScore',
      description: 'Live 2x2 confusion matrix simulator calculating Precision, Recall, F1, and Accuracy, paired with Generative AI (GenAI) text evaluation metrics.',
